...
class AutoEncoder(ODEncoder2Decoder):
    def __init__(self, in_dim, input_noise_factor, latent_noise_factor):
        fold_rate = 5
        kernel_size = 5
        enc_channel_list = [4, 4, 4, 4]
        dec_channel_list = [4, 256, 256, 8]
        super(AutoEncoder, self).__init__(in_dim, kernel_size, fold_rate, input_noise_factor, latent_noise_factor,
                                          enc_channel_list, dec_channel_list)
